...
if __name__ == '__main__':
    print('2-й вторник апреля:', text_to_date('2-й понедельник апреля'))
    print('3-й четверг октября:', text_to_date('3-й четверг октября'))
    print('4-я среда мая:', text_to_date('4-я среда май'))
    print('3-е воскресенье января:', text_to_date('3-е воскресенье января'))