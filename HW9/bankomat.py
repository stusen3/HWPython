...
def menuAtm():
    print('--'*20)
    print(f'Добро пожаловать в банкомат!')
    print()
...
def invoiceIn(money):
    while True :
        print(f'Положите сумму кратно 50')
        moneyIn = int(input(' ->> '))
        if moneyIn%50 != 0 :
